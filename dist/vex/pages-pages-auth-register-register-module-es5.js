(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-auth-register-register-module"], {
    ...
    function srcAppPagesPagesAuthRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function RegisterComponent_mat_icon_34_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "mat-icon", 22);
        }
      ...
      function RegisterComponent_mat_icon_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "mat-icon", 22);
        }
      ...
      var RegisterComponent = /*#__PURE__*/function () {
        function RegisterComponent(router, fb, cd, snackbar, authService) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      this.snackbar.open('Please fill up all fields with valid input.', 'OK', {
                        duration: 5000
                      });
                      return _context.abrupt("return");

                    case 4:
                      reg = this.form.getRawValue();
                    ...
                    case 8:
                      _context.prev = 8;
                      _context.next = 11;
                      return this.authService.signup(reg.name, reg.email, reg.password);
                    ...
                    case 15:
                      ...
                      m = _context.t0.error ? _context.t0.error : _context.t0.message ? _context.t0.message : 'An error occurred with sign-up. Pleas try again later.';
      ...
      RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function RegisterComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_33_listener() {
              return ctx.toggleVisibility();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_43_listener() {
              return ctx.send();
            });
